...
datum_von DATE,
datum_bis DATE,
CONSTRAINT fk_v_nr FOREIGN KEY (v_nr) REFERENCES veranstaltungsort(v_id),
CONSTRAINT fk_i_nr FOREIGN KEY (i_nr) REFERENCES interpret(i_id),
CONSTRAINT pk_in_ver PRIMARY KEY (i_nr, datum_von)
);
